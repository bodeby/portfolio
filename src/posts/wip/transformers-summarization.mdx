---
title: 'Summarization: Utilizing text2text models'
publishedAt: '2024-07-27'
summary: 'Summarization creates a shorter version of a document or an article that captures all the important information. Along with translation, it is another example of a task that can be formulated as a sequence-to-sequence task.'
tag: 'personal'
---
...
- [fine-tuning-azure](https://learn.microsoft.com/en-us/windows/ai/fine-tuning)
- [fine-tuning-hf](https://huggingface.co/docs/transformers/training#train-in-native-pytorch)
- [transformers-js]()