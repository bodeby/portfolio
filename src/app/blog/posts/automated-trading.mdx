---
title: 'Bachelor: Automated Trading'
...
import BlogCard from "../components/common/blog-card.tsx";

<div>
    Hello World
</div>

To address these challenges and level the playing field for retail investors, an automated trading system that minimizes risks and eliminates pitfalls such as emotional trading could prove to be beneficial. The system devel- oped during this project, incorporates various models and techniques, including word2vec for semantic analysis, sentiment analysis, ARIMA for time series prediction, Monte Carlo simulations for value-at-risk calculations, and portfolio optimization. The system aims to provide retail investors with a dynamic portfolio allocation strategy based on algorithmic strategies.
